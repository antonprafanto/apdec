...
| Item | Spesifikasi | Qty | Harga Satuan (IDR) | Total (IDR) | Keterangan |
|------|-------------|-----|-------------------|------------|-----------|
| **LED Floodlight** | Philips Master LED 50W IP65 | 2 | 1.200.000 | 2.400.000 | 5000K daylight, weatherproof |
| **Light Mounting Bracket** | Adjustable angle bracket | 2 | 350.000 | 700.000 | For optimal positioning |
| **Photocell Sensor** | Auto on/off sensor | 1 | 450.000 | 450.000 | Automatic lighting control |
| **Subtotal Lighting System** | | | | **3.550.000** | |

### 1.3. Network Infrastructure
| Item | Spesifikasi | Qty | Harga Satuan (IDR) | Total (IDR) | Keterangan |
|------|-------------|-----|-------------------|------------|-----------|
| **Network Switch** | D-Link DGS-108 8-Port Gigabit | 1 | 650.000 | 650.000 | Metal housing, desktop/wall mount |
| **Ethernet Cable** | Cat6 UTP 30m outdoor grade | 1 | 850.000 | 850.000 | Weather protection jacket |
| **Cable Connectors** | RJ45 Cat6 connectors (pack) | 1 | 250.000 | 250.000 | High-quality connectors |
| **Network Patch Panel** | 8-port patch panel | 1 | 550.000 | 550.000 | Organized cable management |
| **Subtotal Network Infrastructure** | | | | **2.300.000** | |

### 1.4. Power & Backup System
| Item | Spesifikasi | Qty | Harga Satuan (IDR) | Total (IDR) | Keterangan |
|------|-------------|-----|-------------------|------------|-----------|
| **UPS System** | APC Back-UPS 600VA BE600M1 | 1 | 1.200.000 | 1.200.000 | 5 minute runtime, surge protection |
| **Power Distribution Unit** | Industrial PDU with surge protection | 1 | 850.000 | 850.000 | Multiple protected outlets |
| **Power Cable** | Heavy-duty extension cord 10m | 2 | 250.000 | 500.000 | Outdoor rated, grounded |
| **Subtotal Power System** | | | | **2.550.000** | |

### 1.5. Enterprise AI Workstation (Optimized Production System)
| Item | Spesifikasi | Qty | Harga Satuan (IDR) | Total (IDR) | Keterangan |
|------|-------------|-----|-------------------|------------|-----------|
| **Industrial Chassis** | Rack mount 2U industrial grade | 1 | 5.000.000 | 5.000.000 | Dust protection, optimal cooling |
| **Motherboard** | Industrial workstation grade (B760) | 1 | 7.500.000 | 7.500.000 | PCIe 4.0, ECC support, stable |
| **Processor** | Intel Core i7-13700 (16-core, 24-thread) | 1 | 12.000.000 | 12.000.000 | Optimal for single camera AI |
| **Primary GPU** | NVIDIA RTX 4070 12GB GDDR6X | 1 | 18.000.000 | 18.000.000 | Optimal for 4MP @ 30fps real-time |
| **System Memory** | 32GB DDR5 5600MHz ECC Kit | 1 | 7.000.000 | 7.000.000 | Sufficient for single camera |
| **Primary Storage** | 1TB NVMe Gen 4 SSD (Samsung 980 Pro) | 1 | 2.500.000 | 2.500.000 | OS, applications, database |
| **Data Storage** | 4TB SATA SSD (Samsung 870 EVO) | 1 | 3.500.000 | 3.500.000 | ~84 days video retention @ 4MP 30fps |
| **Power Supply** | 850W 80+ Gold redundant | 1 | 3.500.000 | 3.500.000 | Adequate power untuk RTX 4070 |
| **Cooling System** | Industrial-grade air cooling | 1 | 2.000.000 | 2.000.000 | Low maintenance, 24/7 ready |
| **Network Interface** | Dual 1GbE Ethernet with failover | 1 | 1.500.000 | 1.500.000 | Sufficient for single camera |
| **OS License** | Windows 11 Pro OEM | 1 | 2.500.000 | 2.500.000 | Production OS license |
| **Remote Management** | Intel vPro platform | 1 | 1.500.000 | 1.500.000 | Built-in remote management |
| **Extended Warranty** | 3-year on-site business support | 1 | 5.000.000 | 5.000.000 | Business-class support |
| **Subtotal Optimized Workstation** | | | | **61.500.000** | |

### 1.6. Safety & Security Equipment
| Item | Spesifikasi | Qty | Harga Satuan (IDR) | Total (IDR) | Keterangan |
|------|-------------|-----|-------------------|------------|-----------|
...
**TOTAL HARDWARE & EQUIPMENT: RP 78.250.000**
...
### 2.4. Development Tools & Cloud Services
| Item | Spesifikasi | Qty | Harga Satuan (IDR) | Total (IDR) | Keterangan |
|------|-------------|-----|-------------------|------------|-----------|
...
**TOTAL INSTALLATION & SETUP: RP 12.000.000**
